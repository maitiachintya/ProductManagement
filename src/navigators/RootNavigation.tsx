...
export const navigationRef = createNavigationContainerRef<
  RootAuthStackParamList & RootMainStackParamList
>();

// Navigate function with correct typing and format
export function navigate<
  RouteName extends keyof (RootAuthStackParamList & RootMainStackParamList),
>( // (RootMainStackParamList & SettingsStackProps)>
  name: RouteName,
...
export function reset(
  index: number,
  name: keyof (RootAuthStackParamList & RootMainStackParamList),
) {
  if (navigationRef.isReady()) {
    navigationRef.reset({
      index: index,
